...
import {default as Styles} from '../skins/orange/background.less';
...
const Background = () => {
    ...
    return (
        <div className={Styles.background} ref={background} data-relative-input="true">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                ...
                <g id="jjperezaguinaga">
                    ...
                    <g id="innerCircles">
                        <path id={Styles['circle5']} fill="#F15C27" d="M288.569,200.171c0.433-34.354-21.302-67.555-52.857-81.048
                        ...
                        <path id={Styles['circle4']} fill="#EE7D8F" d="M284.937,200.171c0.051-19.738-7.062-39.39-19.792-54.483
                        ...
                        <path id={Styles['circle3']} fill="#E8D320" d="M282.087,200.171c0.102-21.531-8.755-42.883-24.042-58.042
                        ...
                        <path id={Styles['circle1']} fill="#2D948D" d="M279.073,200.171c0.505-32.562-21.546-63.749-52.265-74.399
                        ...
                        <path id={Styles['circle2']} fill="#69C8C3" d="M276.892,200.171c0.088-20.185-8.191-40.148-22.521-54.367
